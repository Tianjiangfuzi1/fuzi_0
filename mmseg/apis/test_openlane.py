...
def test_openlane(model,
    ...
    result, ret_dict = evaluate_python(label_path='/root/autodl-tmp/newkitti1(480*320)/label/validation/',
                                       result_path='/root/autodl-tmp/Anchor3DLane/output/openlane/waymo-kitti/validation/',
                                       label_split_file='/root/autodl-tmp/data/OpenLane/data_lists/validation.txt',
