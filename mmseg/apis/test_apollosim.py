...
def test_apollosim(cfg,
    ...
    for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loader2):
        result_dict, result_str, dis_ious = inference(
            model,
            data_loader2,
