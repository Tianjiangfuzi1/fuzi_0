...
def test_openlane(model,
    ...
    # result, ret_dict = evaluate_python(label_path='/home3/wr21125091/newkitti1(480*320)/label/validation/',
    #                                    result_path='/home2/wr21125091/Anchor3DLane2/output/openlane/waymo-kitti/validation/',
    #                                    label_split_file='/home2/wr21125091/Anchor3DLane/data/OpenLane/data_lists/validation.txt',
    #                                    current_class=("Car", "Pedestrian", "Cyclist"),
    #                                    metric='R40')
    # print("Object Detection result is /n")
    # print(ret_dict)
    # print(result)
    #
    # if eval:
    ...
    if show:
        ...
        visualizer.visualize(pred_file, img_dir=dataset.data_root,
                             test_file=dataset.test_list,
                             save_dir=save_dir, prob_th=prob_th)
