...
class OpenlaneDataset(Dataset):
    ...
    def __getitem__(self, idx, transform=False):
        ...
        # results['calib']['extrinsics'] = []
        # results['calib']['lidar2img'] = []
        # results['gt_3dbox'] = {}
    ...
    def pad_image(self, image):
        img = np.array(image)
        h, w, c = img.shape
        ret_img = np.zeros((self.input_szie[0], self.input_size[1], c))
        pad_y = (self.input_size[0] - h) // 2
        pad_x = (self.input_size[1] - w) // 2
