...
# _C.MODEL.BACKBONE.CONV_BODY = "ResNet18"
...
_C.MODEL.HEAD.DIMENSION_MEAN = ((4.8164, 1.8017, 2.106),
                               (0.9102, 1.7475, 0.8524),
                               (1.7613, 1.7526, 0.829))
...
_C.MODEL.HEAD.DIMENSION_STD = ((1.2327, 0.4348, 0.2972),
							   (0.1932, 0.1998, 0.1541),
							   (0.2865, 0.2092, 0.125))
